    ...
    buttonClicked: function(data) {
      ...
      switch (clicked) {
        ...
        this.switchTo('ticket', {
          ...
          ticketTypes: [{name: 'Question', value: 'question'}, {name: 'Problem', value: 'problem'}, {name: 'Incident', value: 'incident'}, {name: 'Task', value: 'task'}],
          ticketCCs: this.ticket().collaborators()
        });
